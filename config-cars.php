...
define('ITEM_ID', 'id_[table]'); // probable alternative: '[table]_id', '[table]ID', 'id'
...
define('CREATION_DATE', 'create_date');
...
define('RELATED_FIELD_NAMES', ['*'=>'name']);
...
<?php
/**
 * Test with another DB with different naming convention
 * 
 * Dressapi test with the car2db database (https://car2db.com/).
 * 
 * - Download database from https://car2db.com/
 * - Create a new DB named "cars".
 * - Import the dowloaded file into cars DB. 
 * - Configure the connection data in the DB_ * definitions (in particular DB_USERNAME and DB_PASSWORD).
 * - In the index.php file replace config.php with this file: config-cars.php.
 * 
 * - Run same queries, like:
