          ...
          <div class="col-lg-4 col-md-4 pb-2">
            <div class="pb-2">
              ...
              <ul class="list-inline text-left social">
                <li class="list-inline-item"><a class="p-2 text-white" href="#" target="_blank"><svg class="icon icon-sm icon-white align-top"><use xlink:href="/cms/bootstrap-italia/dist/svg/sprite.svg#it-designers-italia"></use></svg><span class="sr-only">Designers Italia</span></a></li>
                <li class="list-inline-item"><a class="p-2 text-white" href="#" target="_blank"><svg class="icon icon-sm icon-white align-top"><use xlink:href="/cms/bootstrap-italia/dist/svg/sprite.svg#it-twitter"></use></svg><span class="sr-only">Twitter</span></a></li>
                <li class="list-inline-item"><a class="p-2 text-white" href="#" target="_blank"><svg class="icon icon-sm icon-white align-top"><use xlink:href="/cms/bootstrap-italia/dist/svg/sprite.svg#it-medium"></use></svg><span class="sr-only">Medium</span></a></li>
                <li class="list-inline-item"><a class="p-2 text-white" href="#" target="_blank"><svg class="icon icon-sm icon-white align-top"><use xlink:href="/cms/bootstrap-italia/dist/svg/sprite.svg#it-behance"></use></svg><span class="sr-only">Behance</span></a></li>
              </ul>
            </div>
            <div class="pb-2">
...
<script>window.__PUBLIC_PATH__ = "/cms/bootstrap-italia/dist/fonts"</script>

<script src="/cms/bootstrap-italia/dist/js/bootstrap-italia.bundle.min.js"></script>

<script src="/cms/js/dressapi.js"></script>
...
<div class="notification dismissable with-icon" role="alert" id="liveToast" aria-labelledby="liveToast-title">
  <h5 id="liveToast-title">
    <svg class="icon">
      <use xlink:href="/cms/bootstrap-italia/dist/svg/sprite.svg#it-info-circle"></use></svg>Esempio di utilizzo
  </h5>
  <p>
    <a href="/cms/bootstrap-italia/docs/esempi/">Torna alla pagina principale degli esempi</a>
  </p>
  <button type="button" class="btn notification-close">
    <svg class="icon">
      <use xlink:href="/cms/bootstrap-italia/dist/svg/sprite.svg#it-close"></use>
    </svg>
